...
theme.fs = lain.widget.fs({
    ...
    settings = function()
        local fsp = string.format(" %3.2f/%3.2f%s ", fs_now["/"].used, fs_now["/"].size, fs_now["/"].units)
...
local net = lain.widget.net({
    ...
    settings = function()
        widget:set_markup(markup.font(theme.font,
                          markup("#7AC82E", " " .. string.format("%04.1f", net_now.received) .. "Mbps")
                          .. " " ..
                          markup("#46A8C3", " " .. string.format("%04.1f", net_now.sent) .. "Mbps ")))
    end
})
